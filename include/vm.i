...
OP_VM_ACTOR_GET_BOUNDS          = 0x3B
.macro VM_ACTOR_GET_BOUNDS IDX
        .db OP_VM_ACTOR_GET_BOUNDS, #>IDX, #<IDX
.endm

OP_VM_ACTOR_GET_BOUNDS_POS      = 0x8F
.macro VM_ACTOR_GET_BOUNDS_POS IDX
        .db OP_VM_ACTOR_GET_BOUNDS_POS, #>IDX, #<IDX
.endm